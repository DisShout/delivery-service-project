...
class RabbitService:
    ...
    async def send_message_to_rabbit(self, message: ParcelCreate, session_id: str):
        async with self.producer as producer:
            await producer.setup()

            payload = {"session_id": session_id, "parcel": message.model_dump()}
    ...
    async def process_message(self, message: dict):
        ...
        async with get_session_context() as db:
            ...
            await service.calculate_delivery_price_and_create_parcel(parcel, session_id)
